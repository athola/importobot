...
class TestLocalStorageQuery:
    ...
    def test_query_data_failure(self, storage_backend: LocalStorageBackend) -> None:
    ...
    def test_list_data_ids_success(
        self,
        storage_backend: LocalStorageBackend,
        sample_data: dict[str, Any],
        sample_metadata: LayerMetadata,
    ...
    def test_list_data_ids_empty_layer(
        self, storage_backend: LocalStorageBackend
    ) -> None:
    ...
    def test_list_data_ids_nonexistent_layer(
        self, storage_backend: LocalStorageBackend
    ) -> None:
...
class TestLocalStorageMaintenance:
    ...
    def test_cleanup_old_data_empty_layer(
        self,
        storage_backend: LocalStorageBackend,
    ) -> None:
    ...
    def test_cleanup_old_data_nonexistent_layer(
        self,
        storage_backend: LocalStorageBackend,
    ) -> None:
    ...
    def test_backup_layer_nonexistent(
        self, storage_backend: LocalStorageBackend, temp_dir: Path
    ) -> None:
    ...
    def test_restore_layer_nonexistent_backup(
        self, storage_backend: LocalStorageBackend, temp_dir: Path
    ) -> None:
    ...
    def test_restore_layer_failure(self, storage_backend: LocalStorageBackend) -> None:
...
class TestLocalStorageInternals:
    ...
    def test_matches_query_with_filters(
        self,
        storage_backend: LocalStorageBackend,
    ) -> None:
    ...
    def test_build_layer_data(
        self, storage_backend: LocalStorageBackend, sample_metadata: LayerMetadata
    ) -> None:
    ...
    def test_process_metadata_files(
        self,
        storage_backend: LocalStorageBackend,
        temp_dir: Path,
        sample_data: dict[str, Any],
    ...
    def test_empty_layer_data(self, storage_backend: LocalStorageBackend) -> None:
